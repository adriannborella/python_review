...
def test_merge_k_lists():
    ...
    # Test heap approach
    result1 = merge_k_lists([create_list([1, 4, 5]), create_list([1, 3, 4]), create_list([2, 6])])
    print(f"Heap approach: {list_to_array(result1)}")
    
    # Test divide & conquer
    result2 = merge_k_lists_divide_conquer([create_list([1, 4, 5]), create_list([1, 3, 4]), create_list([2, 6])])
